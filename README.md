...
**Description**: Python package to assess and improve public speaking for hesistant scientists! 
...
Below is an examples of the interactive HTML report generated by Converser tool for the Martin Luther King Jr. ("I Have a Dream") speech:

![HTML Report Overview](./Images/Transcript.png)
*Overview of the HTML report showing the transcript and summary metrics*

![Performance Metrics Table](./Images/Summary_Metrics.png)
*Core performance metrics with color-coded scoring system*

![Time Window Analysis](./Images/Emotional_Metrics.png)
*Emotional and Zero Shot classification metrics*

![Time Window Analysis](./Images/Graphs.png)
*Interactive plots showing how each metrics changes across the time windows*
...
If you use Converser in your research, please cite:
```
@software{Converser,
  author = {Matthew Higgins},
  title = {Converser: AI-Powered Public Speaking Analysis},
  url = {https://github.com/MatthewHiggins2017/Converser},
  year = {2025}
}
```